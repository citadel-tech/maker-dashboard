    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="sm:col-span-2">
            ...
            <p className="text-xs text-gray-500 mt-1">
              host:port — 8332 mainnet · 18332 testnet · 18443 regtest · 38332 signet
            </p>
          </div>
          ...
          <div className="sm:col-span-2">
            <div className="flex items-center justify-between bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 max-w-xs">
              <div>
                ...
                <div className="text-xs text-gray-500">Use taproot wallet type</div>
              </div>
              <button
                type="button"
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div>
              <label className="block text-sm text-gray-400 mb-2">ZMQ Endpoint</label>
              <input
                type="text"
                value={zmq}
            ...
            <div className="bg-yellow-900/20 border border-yellow-800/30 rounded-lg p-3">
              <p className="text-xs text-yellow-400">
                <strong>Note:</strong> Both zmqpubrawblock and zmqpubrawtx must use the same endpoint.
              </p>
            </div>
          </div>

          <div className="space-y-3">
            <h4 className="text-sm font-medium text-gray-300">bitcoin.conf snippet</h4>
            <div className="bg-gray-800 rounded-lg p-4 font-mono text-xs text-gray-300">
              zmqpubrawblock={zmq || "tcp://127.0.0.1:28332"}<br />
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div>
            <label className="block text-sm text-gray-400 mb-2">Tor Auth Password</label>
            <div className="relative">
              <input
          ...
          <div className="opacity-50">
            ...
            />
            <p className="text-xs text-gray-500 mt-1">SOCKS5 proxy port for Tor</p>
          </div>

          <div className="opacity-50">
            <div className="flex items-center gap-2 mb-2">
              <label className="block text-sm text-gray-400">Control Port</label>
              <ComingSoonBadge />
            </div>
            <input
              type="number"
              ...
              className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg text-gray-100 cursor-not-allowed"
            />
            <p className="text-xs text-gray-500 mt-1">Control port for Tor interface</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6 opacity-60">
        <div className="flex items-center gap-3 mb-6">
          <h3 className="text-lg font-semibold">Swap & Fidelity Configuration</h3>
          <ComingSoonBadge />
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
      ...
      <div className="bg-blue-900/20 border border-blue-800/30 rounded-lg p-4">
        <p className="text-xs text-blue-400">
          <strong>Note:</strong> Saving will update the config and restart this maker.
          Password fields are write-only — leave blank to keep the current value.
        </p>
      </div>
      ...
      <div className="bg-gray-900 border border-red-900/40 rounded-xl p-4 sm:p-6">
        ...
        <p className="text-sm text-gray-400 mb-4">
          Remove this maker from the dashboard. This does not affect your funds or on-chain state.
        </p>
        <button
          type="button"
      ...
      {showRemoveModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 max-w-md w-full shadow-2xl">
            ...
            <p className="text-sm text-gray-400 mb-6">Before you continue, please understand what this does and doesn't do.</p>

            <div className="space-y-3 mb-6">
              <div className="flex gap-3 bg-gray-800 rounded-lg p-3">
                <span className="text-green-400 mt-0.5">✓</span>
                <p className="text-sm text-gray-300">Removes <strong className="text-white">{id}</strong> from this dashboard</p>
              </div>
              <div className="flex gap-3 bg-gray-800 rounded-lg p-3">
                <span className="text-green-400 mt-0.5">✓</span>
                <p className="text-sm text-gray-300">Stops the maker process if it is currently running</p>
              </div>
              <div className="flex gap-3 bg-gray-800 rounded-lg p-3">
                <span className="text-red-400 mt-0.5">✗</span>
                <p className="text-sm text-gray-300">Does <strong className="text-white">not</strong> delete your wallet or funds — those remain in the data directory</p>
              </div>
              <div className="flex gap-3 bg-gray-800 rounded-lg p-3">
                <span className="text-red-400 mt-0.5">✗</span>
                <p className="text-sm text-gray-300">Does <strong className="text-white">not</strong> affect any on-chain state, fidelity bonds, or coinswap history</p>
              </div>
              <div className="flex gap-3 bg-gray-800 rounded-lg p-3">
                <span className="text-red-400 mt-0.5">✗</span>
                <p className="text-sm text-gray-300">Cannot undo blockchain transactions — nothing on-chain is ever "deleted"</p>
              </div>
            </div>

            <p className="text-xs text-gray-500 mb-6">
              You can re-add this maker at any time by pointing to the same data directory.
            </p>
