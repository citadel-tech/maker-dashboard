        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 bg-gray-800 rounded-lg hover:bg-gray-700 transition-all text-sm disabled:opacity-50"
            >
            ...
            <button
              ...
              className="px-4 py-2 border border-gray-700 rounded-lg hover:bg-gray-800 hover:border-orange-500 transition-all text-sm disabled:opacity-50"
            >
